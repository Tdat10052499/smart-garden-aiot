...
export function LiveCamFeed() {
  ...
  return (
    <div className="bg-white rounded-[12px] p-6 shadow-sm">
      ...
      {/* 16:9 Container */}
      <div className="relative aspect-video bg-gray-900 rounded-[12px] overflow-hidden mb-4">
        <ImageWithFallback
        ...
        {/* Scanning Overlay */}
        {isScanning && (
          <div className="absolute inset-0 bg-[#72BF44]/20 backdrop-blur-sm flex items-center justify-center">
      ...
      <button
        ...
        disabled={isScanning}
        className="w-full bg-[#2D5A27] hover:bg-[#234520] text-white py-3 px-6 rounded-[12px] transition-all disabled:opacity-50 disabled:cursor-not-allowed"
      >
